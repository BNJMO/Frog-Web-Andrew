...
export async function initializeMinesGame(config = {}) {
  ...
  const opts = {
    ...
    grid: 5,
    mines: 5,
    diamondTexturePath: "src/mines/assets/sprites/Diamond.png",
    bombTexturePath: "src/mines/assets/sprites/Bomb.png",
    ...
    explosionSheetPath: "src/mines/assets/sprites/Explosion_Spritesheet.png",
    explosionSheetCols: 7,
    explosionSheetRows: 3,
    explosionSheetFps: 24,
    explosionSheetScaleFit: 1.0,
    explosionSheetOpacity: 0.2,
    tileTapDownSoundPath: "src/mines/assets/sounds/TileTapDown.wav",
    tileFlipSoundPath: "src/mines/assets/sounds/TileFlip.wav",
    tileHoverSoundPath: "src/mines/assets/sounds/TileHover.wav",
    diamondRevealedSoundPath: "src/mines/assets/sounds/DiamondRevealed.wav",
    bombRevealedSoundPath: "src/mines/assets/sounds/BombRevealed.wav",
    winSoundPath: "src/mines/assets/sounds/Win.wav",
    gameStartSoundPath: "src/mines/assets/sounds/GameStart.wav",
